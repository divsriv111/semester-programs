...
#include<cstring>
using namespace std;
char book[5][10]={{"maths"},{"english"},{"physics"},{"chemistry"},{"hindi"}},book2[10],author2[10],author[5][5]={{"A"},{"B"},{"C"},{"D"},{"E"}};
int ncopy[5]={3,3,3,3,3},cost[5]={10,20,30,40,50},temp,noofcopy;
class books{
